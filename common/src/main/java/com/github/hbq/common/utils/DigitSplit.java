...
public final class DigitSplit {
  ...
  public interface ISplitter {
    ...
    /**
     * 对齐分割,针对时间分割会做对齐处理, 需要step、start、end都使用秒来计算
     *
     * @param start
     * @param end
     * @return
     */
    List<Segment> alignSplit(long start, long end);
  ...
  static class DefaultSplitter implements ISplitter {
    ...
    @Override
    public List<Segment> alignSplit(long start, long end) {

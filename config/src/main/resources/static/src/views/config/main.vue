<template>
  <div class="common-layout">
    ...
    <el-dialog v-model="searchDialogFormVisible" title="查询配置" :fullscreen="false" width="70%">
      ...
      <el-table :data="searchData" style="width: 100%;" height="250px" :border="true" table-layout="fixed" :stripe="true"
    ...
    <el-dialog v-model="historyDialogFormVisible" title="历史操作记录" :fullscreen="false" width="60%">
      ...
      <el-table :data="historyData" style="width: 100%;" height="250px" :border="true" table-layout="fixed" :stripe="true"
                size="small" :highlight-current-row="true">
